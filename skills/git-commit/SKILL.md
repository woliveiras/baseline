...
5. Compare the cached candidate with the authorized task, current spec/matrix, tests, evidence, documentation decision, and completed review. Stop if ownership or scope is ambiguous.
