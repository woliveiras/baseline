...
2. Run spec review with objective, full spec, criteria, domain, invariants, and reproduction only. Produce the behavior/oracle matrix and a compact review record without tests, diff, or new implementation.
