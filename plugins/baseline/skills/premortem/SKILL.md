---
name: premortem
description: Anticipate plausible failure modes for a proposed software change and convert them into proportional mitigations, expected checks, detection, and rollback. Use before committing to medium or high-risk work; do not use to generate generic risk lists for trivial changes.
---
...
1. Read the governing input, expected behavior, architecture, dependencies, authority, rollout, and reversibility.
...
6. Propose expected behavior, tests, observability, rollout guards, rollback steps, or open decisions when justified. Edit a governing input or durable artifact only with explicit authority for that artifact; analysis alone grants no write authority.
