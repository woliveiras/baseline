...
Use a postmortem only after an incident that meets the project's documented threshold, such as material user impact, data loss, manual emergency intervention, excessive recovery time, or a monitoring failure. Do not use it as a blame record or as generic release notes.
