...
class EvaluationVerifierTests(unittest.TestCase):
    ...
    def test_promptfoo_behavior_conditionally_loads_the_focal_skill(self):
        ...
        self.assertIn("Before any fixture inspection, project command, or response", prompt)
        self.assertIn("load the assigned workflow", prompt)
        self.assertIn("Only after workflow loading", prompt)
