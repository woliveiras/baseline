...
| [0004](./0004-package-canonical-skills-with-open-and-native-adapters.md) | Package canonical skills with an open manifest and thin native adapters | accepted | 2026-08-10 | Use one Agent Plugins manifest for Cursor and Copilot, retain Codex, add declarative Claude and Pi adapters, and keep one skill tree. |
